...
angular.module('ui.scrollx', []).directive('ngScrollViewport', [
		'$log', function() {
			return {
				controller: [
		...
		'$injector', '$rootScope', '$timeout', function($injector, $rootScope, $timeout) {
			return {
